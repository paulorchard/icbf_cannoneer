...
/**
 * Registers a custom creative tab for the mod. The tab uses the vanilla spyglass
 ...
 * for development and small mods. If you prefer the DeferredRegister/RegisterEvent
 * pattern you can replace this with an event-driven registration.
 */
public final class ModCreativeTabs {
    private ModCreativeTabs() {}

    public static final DeferredRegister<CreativeModeTab> CREATIVE_TABS = DeferredRegister.create(Registries.CREATIVE_MODE_TAB, IslandCraftMod.MODID);
            ...
            () -> CreativeModeTab.builder()
                    ...
                    .displayItems((features, output) -> {
                        ...
                        try {
                            ...
                            // Fallback: try accepting an ItemStack
                            try {
                                output.accept(new ItemStack(Items.SPYGLASS));
                            } catch (Throwable __) {
                                com.islandcraft.IslandCraftMod.LOGGER.warn("Failed to add spyglass to creative tab: {}", t.toString());
                            }
                        }
                    })
                    .build());
